...
export default function SettingsUsersPage() {
  ...
  const handleChangePassword = async (user: User) => {
    await showPasswordDialog({
      ...
      message: `إدخال كلمة مرور جديدة للموظف "${user.username}"`,
            ...
            <div className="mb-4 flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
              <div>
                ...
                <p className="mt-2 max-w-2xl text-[14px] leading-relaxed text-obsidian/65">
                  ...
                  الظاهر في التقارير وعلى الطلبات؛ وهو نفسه المعرف الذي يُدخل عند تسجيل الدخول (لا يوجد
                  حقل منفصل لاسم الدخول).
                </p>
              </div>
              <button
                type="button"
                ...
                <table className="w-full">
                  <thead>
                    <tr className="border-b border-black/10">
                      ...
                      <th className="text-right py-3 px-4 text-[13px] font-medium text-obsidian/70 w-32">
                        إجراءات
                      </th>
                    </tr>
                  </thead>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-obsidian/70 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-soft-xl bg-white p-6 shadow-soft">
            ...
            <div className="space-y-4">
              ...
              <div>
                <label className="block text-[13px] leading-relaxed font-medium text-obsidian mb-1.5">
                  كلمة المرور {editingUser && '(اتركه فارغاً للاحتفاظ بالكلمة الحالية)'}
                </label>
                <input
                  type="password"
                  value={formPassword}
              ...
              {formRole === 'customer' && (
                <>
                  <div className="flex items-center gap-2">
                    ...
                    />
                    <label htmlFor="requireCaptainApproval" className="text-[13px] leading-relaxed text-obsidian cursor-pointer">
                  ...
                  <div className="flex items-center gap-2">
                    <input
                      ...
                      className="w-4 h-4 text-cyber-aqua focus:ring-cyber-aqua"
                    />
                    <label htmlFor="customerFreeOrder" className="text-[13px] leading-relaxed text-obsidian cursor-pointer">
                      طلب مجاني
                    </label>
                  </div>
                </>
