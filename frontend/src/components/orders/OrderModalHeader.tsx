...
export function OrderModalHeader({
  ...
  const actionBtnClass =
    'flex items-center justify-center gap-1.5 rounded-xl px-4 py-3 text-[16px] sm:text-[17px] md:rounded-md md:px-1.5 md:py-1 md:text-[11px] xl:px-4 xl:py-3 xl:text-[17px] leading-normal font-bold text-white whitespace-nowrap';
